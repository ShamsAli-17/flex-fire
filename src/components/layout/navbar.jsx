  ...
  return (
    <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${
      scrolled 
        ...
        : 'bg-gradient-to-r from-black/80 via-black/60 to-black/80 backdrop-blur-sm'
    }`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          
          {/* Brand Logo - Updated to match hero colors */}
          ...
          {/* Connect Now Button - Updated to match hero button colors */}
          <div className="hidden lg:block">
            <button
          ...
          <div className="px-4 py-6 space-y-3">
            {navItems.map((item) => (
              <a
                key={item.name}
                href={item.href}
                className="block px-4 py-3 text-gray-300 hover:text-white hover:bg-red-600/10 rounded-lg font-medium transition-all duration-200"
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white px-6 py-3 rounded-lg font-semibold transition-all duration-200 flex items-center justify-center space-x-2 mt-4"
            >
              <WhatsAppIcon />
              <span>Connect Now</span>
            </button>
